...
public class Regex_Address_Test2 {
    ...
    static {
        try {
            writer = new FileWriter(new File("C:\\Users\\Hasee\\Desktop\\initAddress\\未处理地址类型.txt"));
            writer1 = new FileWriter(new File("C:\\Users\\Hasee\\Desktop\\initAddress\\规范地址类型.txt"));
    ...
    public static void Regex_Address(String Address_allName) throws IOException {
        ...
        if (Pattern.matches("(\\w+识别号)", Address_allName)){
            ...
            if (matcher0.find()){
                ...
                writer1.append(matcher0.group(1));
                writer1.append("\r\n");
                writer1.flush();
            }
        }
        ...
        //处理标准弄临号  12弄12临号
            ...
            if (matcher0.find()){
                ...
                writer1.append(matcher0.group(1));
                writer1.append("\r\n");
                writer1.append(matcher0.group(2));
                writer1.append("\r\n");
                writer1.flush();
        ...
        //处理标准弄支弄号    12弄12支弄12号
            ...
            if (matcher0.find()){
                ...
                writer1.append(matcher0.group(2));
                writer1.append("\r\n");
                writer1.append(matcher0.group(3));
                writer1.append("\r\n");
                writer1.flush();
            }
        }
    ...
    public static String getAddress_Ritht_Name(String Address_allName){
            //123识别    207-1  123123   599临      1869-8临    26甲 515B
