...
public class Regex_Address_Test3 {
    ...
    static {
        try {
            writer = new FileWriter(new File("C:\\Users\\Hasee\\Desktop\\initAddress\\未处理.txt"));
            writer1 = new FileWriter(new File("C:\\Users\\Hasee\\Desktop\\initAddress\\已处理地址类型.txt"));
    ...
    public static void Regex_Address(String Address_allName) throws IOException {
        ...
        //处理标准弄支弄幢 -    4弄4支弄4幢4-4
            ...
            if (matcher0.find()){
                ...
                writer1.append(matcher0.group(3));
                writer1.append("\r\n");
                writer1.append(matcher0.group(4));
                writer1.append("\r\n");
                writer1.flush();
            }
        }else{
